...
# For repeated itineraries, compare prices in eDreams vs Kiwi
...
for itinerary_id in repeated_itineraries:
    # Find the repeated itinerary's price in both datasets.
...
# Total repeated itineraries count
...
# ----------------- Overall Cheaper Itineraries Percentage -----------------
# Count how many eDreams itineraries are cheaper than Kiwi's cheapest price.
eDreams_cheaper_than_kiwi = len([entry for entry in edreams_data if float(entry["price"]) < cheapest_kiwi_price])
# Count how many Kiwi itineraries are cheaper than eDreams' cheapest price.
kiwi_cheaper_than_edreams = len(cheaper_kiwi_itineraries)

percent_eDreams_cheaper_than_kiwi = 100 * eDreams_cheaper_than_kiwi / len(edreams_data)
percent_kiwi_cheaper_than_edreams = 100 * kiwi_cheaper_than_edreams / len(kiwi_data)

print(f"\nPercentage of eDreams itineraries cheaper than Kiwi's cheapest: {percent_eDreams_cheaper_than_kiwi:.2f}%")
print(f"Percentage of Kiwi itineraries cheaper than eDreams' cheapest: {percent_kiwi_cheaper_than_edreams:.2f}%")
